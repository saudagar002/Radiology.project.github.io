      ...
      const viewerHTML = `
        ...
        <html>
          <head>
            <meta charset="utf-8">
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <title>CAIB Viewer</title>
            <!-- Add your CSS links here -->
          </head>
          <body>
            <!-- Your HTML content for the viewer goes here -->
            <h1>Viewer for ${file}</h1>
    ...
    <div>
      ...
      <ul>
        {currentItems.map((file, index) => (
          <li key={index}>
            {/* Use a button or link to trigger the viewer */}
            <button onClick={() => handleDisplay(file)}>{file}</button>
          </li>
        ))}
      </ul>
    </div>
